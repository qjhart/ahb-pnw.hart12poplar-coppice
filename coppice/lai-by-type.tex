...
%      legend entries={$\acs{LAIt}_{(\acs{Rdp}=.1)}=0.1$,$\acs{LAIt}_{(\acs{Rdp}=.1)}=1$,$\acs{LAIt}_{(\acs{Rdp}=.1)}=.1$,$\acs{LAIt}_{(\acs{Rdp}=.1)}=1$},
%      legend entries={$\acs{Rdp}=.1 \acs{LAIt}=0$,$\acs{Rdp}=.1 \acs{LAIt}=0.1$,$\acs{Rdp}=.1 \acs{LAIt}=1$,$\acs{Rdp}=1 \acs{LAIt}=.1$,$\acs{Rdp}=1 \acs{LAIt}=1$},
      legend entries={$\acs{LAIt}=0.1$,$\acs{LAIt}=1$,$\acs{LAIt}=10$},
      legend style={
