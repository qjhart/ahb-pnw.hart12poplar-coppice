...
%        at={(0.5,-0.3)},anchor=north,legend columns=-1}
      ...
      \addplot table [color=blue x=date, y=m11f0.05, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
      \addplot table [color=red x=date, y=m11f0.1, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
%      \addplot table [x=date, y=m11f0.2, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
%      \addplot table [x=date, y=m11f0.3, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
      \addplot table [color=green x=date, y=m11f0.5, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
    \end{axis}
  \end{tikzpicture}
  \begin{tikzpicture}
    \begin{axis}[
...
%        at={(0.5,-0.3)},anchor=north,legend columns=-1}
      ...
      \addplot table [x=date, y=m9f0.05, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
      \addplot table [x=date, y=m9f0.1, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
%      \addplot table [x=date, y=m9f0.2, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
%      \addplot table [x=date, y=m9f0.3, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
      \addplot table [x=date, y=m9f0.5, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
    \end{axis}
  \end{tikzpicture}
  \begin{tikzpicture}
    \begin{axis}[
...
%        at={(0.5,-0.3)},anchor=north,legend columns=-1}
      ...
      \addplot table [x=date, y=m7f0.05, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
      \addplot table [x=date, y=m7f0.1, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
%      \addplot table [x=date, y=m7f0.2, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
%      \addplot table [x=date, y=m7f0.3, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
      \addplot table [x=date, y=m7f0.5, col sep=comma] {coppice/hart12coppice-coppice-WS.csv};
    \end{axis}
  \end{tikzpicture}
...
%        at={(0.5,-0.3)},anchor=north,legend columns=-1}
      ...
      \addplot table [x=date, y=m11f0.05, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
      \addplot table [x=date, y=m11f0.1, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
%      \addplot table [x=date, y=m11f0.2, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
%      \addplot table [x=date, y=m11f0.3, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
      \addplot table [x=date, y=m11f0.5, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
    \end{axis}
  \end{tikzpicture}
  \begin{tikzpicture}
    \begin{axis}[
...
%        at={(0.5,-0.3)},anchor=north,legend columns=-1}
      ...
      \addplot table [x=date, y=m9f0.05, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
      \addplot table [x=date, y=m9f0.1, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
%      \addplot table [x=date, y=m9f0.2, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
%      \addplot table [x=date, y=m9f0.3, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
      \addplot table [x=date, y=m9f0.5, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
    \end{axis}
  \end{tikzpicture}
  \begin{tikzpicture}
    \begin{axis}[
...
%        at={(0.5,-0.3)},anchor=north,legend columns=-1}
      ...
      \addplot table [x=date, y=m7f0.05, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
      \addplot table [x=date, y=m7f0.1, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
%      \addplot table [x=date, y=m7f0.2, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
%      \addplot table [x=date, y=m7f0.3, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
      \addplot table [x=date, y=m7f0.5, col sep=comma] {coppice/hart12coppice-coppice-WR.csv};
    \end{axis}
  \end{tikzpicture}
  \caption{Coppice Regrowth fort various coppicing dates.}
  \label{fig:test}
